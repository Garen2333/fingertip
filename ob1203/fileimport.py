...
# Run this file in the folder with the latest binary file.
import os,sys,time
...
s += "\nconst latest_firmware_revision = 'v1.6';" #increment this number to a new version!!!!!!
...
with open("latest_firmware.js", "w") as text_file:
